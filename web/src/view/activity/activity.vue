  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="活动类型(0招新，1待开发)">
            
             <el-input v-model.number="searchInfo.type" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="发起组织id">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" width="180">
         ...
         <el-table-column align="left" label="活动开始时间" width="180">
        ...
        <el-table-column align="left" label="封面" prop="cover" width="120" />
         <el-table-column align="left" label="活动结束时间" width="180">
            <template #default="scope">{{ formatDate(scope.row.endTime) }}</template>
         </el-table-column>
        <el-table-column align="left" label="活动状态(json)" prop="status" width="120" />
        <el-table-column align="left" label="活动名称" prop="title" width="120" />
        <el-table-column align="left" label="活动类型(0招新，1待开发)" prop="type" width="120" />
        <el-table-column align="left" label="发起组织id" prop="userId" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateActivityFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        <el-form-item label="活动开始时间:"  prop="beginTime" >
          <el-date-picker v-model="formData.beginTime" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
        </el-form-item>
...
// 更新行
const updateActivityFunc = async(row) => {
