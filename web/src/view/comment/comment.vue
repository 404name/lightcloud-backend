  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="评论对象id">
            
             <el-input v-model.number="searchInfo.toId" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="评论对象类别">
            
             <el-input v-model.number="searchInfo.toType" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="发表者id">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="描述(a评论了xxx)" prop="describe" width="120" />
        <el-table-column align="left" label="是否匿名（0否，1是）" prop="isAnonymous" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.isAnonymous) }}</template>
        </el-table-column>
        <el-table-column sortable align="left" label="评分" prop="rate" width="120" />
        <el-table-column align="left" label="引用回复" prop="referId" width="120" />
        <el-table-column align="left" label="标签(已毕业、社团成员)" prop="tags" width="120" />
        <el-table-column align="left" label="评论对象id" prop="toId" width="120" />
        <el-table-column align="left" label="评论对象类别" prop="toType" width="120" />
        <el-table-column align="left" label="发表者id" prop="userId" width="120" />
        <el-table-column align="left" label="voteDownNum字段" prop="voteDownNum" width="120" />
        <el-table-column align="left" label="voteUpNum字段" prop="voteUpNum" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateCommentFunc(scope.row)">变更</el-button>
