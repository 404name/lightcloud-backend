  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="消息发起id">
            
             <el-input v-model.number="searchInfo.fromId" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="消息发起方">
            
             <el-input v-model.number="searchInfo.fromType" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="类别(通知，动态，)">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="动态内容" prop="content" width="120" />
        <el-table-column align="left" label="封面" prop="cover" width="120" />
        <el-table-column align="left" label="消息发起id" prop="fromId" width="120" />
        <el-table-column align="left" label="消息发起方" prop="fromType" width="120" />
        <el-table-column align="left" label="是否置顶（0否, 1是）" prop="isTop" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.isTop) }}</template>
        </el-table-column>
        <el-table-column align="left" label="标题(AXX了你/通知)" prop="title" width="120" />
        <el-table-column align="left" label="类别(通知，动态，)" prop="type" width="120" />
        <el-table-column align="left" label="用户id" prop="userId" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateMomentsFunc(scope.row)">变更</el-button>
...
const updateMomentsFunc = async(row) => {
    ...
    type.value = 'update'
    if (res.code === 0) {
        formData.value = res.data.remoments
