...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/activityRecord/deleteActivityRecord": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/activityRecord/deleteActivityRecordByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "批量删除ActivityRecord",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/activityRecord/findActivityRecord": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/activityRecord/getActivityRecordList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/activityRecord/updateActivityRecord": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/introduce/deleteIntroduceByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/organizationInformation/deleteOrganizationInformation": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "删除OrganizationInformation",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/organizationInformation/deleteOrganizationInformationByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "批量删除OrganizationInformation",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/organizationInformation/findOrganizationInformation": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/organizationInformation/getOrganizationInformationList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/organizationInformation/updateOrganizationInformation": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "更新OrganizationInformation",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
