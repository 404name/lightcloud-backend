...
func Routers() *gin.Engine {
	...
	}
	{
		...
		// 部分开放
		// 里面部分需要添加jwt鉴权
		webRouter.InitArticleRouter(PublicGroup)
		webRouter.InitActivityRouter(PublicGroup)
		webRouter.InitActivityRecordRouter(PublicGroup)
		webRouter.InitCommentRouter(PublicGroup)
		webRouter.InitIntroduceRouter(PublicGroup)
		...
		webRouter.InitWebOrganizationRouter(PublicGroup, PublicAuthGroup)
	}
