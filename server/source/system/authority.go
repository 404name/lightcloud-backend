...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		...
		{AuthorityId: 9528, AuthorityName: "组织", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard"},
		{AuthorityId: 8881, AuthorityName: "游客", ParentId: utils.Pointer[uint](888), DefaultRouter: "dashboard"},
	}
